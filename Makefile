...
BUILD_DIR=bin
DOCKER_REGISTRY?=docker.io # Default, can be overridden (e.g., to ghcr.io)
DOCKER_IMAGE_BASE?=$(BINARY_NAME) # Base name for the image, owner/repo will be prefixed in CI
